...
const dashHTML = `<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>Fleet</title>
...
<div class="hdr"><h1><span>&#9670;</span> FLEET</h1><button class="btn btn-p" id="add-btn">+ Add</button></div>
<div class="main"><div class="tabs" id="tabs"><div class="tab active" onclick="switchTab('vehicles')">Vehicles</div><div class="tab" onclick="switchTab('maintenance')">Maintenance</div></div><div class="tab-content active" id="tab-vehicles">
<div class="stats" id="stats-vehicles"></div>
<div class="toolbar">
<input class="search" id="search-vehicles" placeholder="Search..." oninput="renderRes('vehicles')"><select class="filter-sel" id="filter-vehicles-status" onchange="renderRes('vehicles')"><option value="">All Status</option><option value="Active">Active</option><option value="In Service">In Service</option><option value="Out of Service">Out of Service</option><option value="Retired">Retired</option></select></div>
<div class="count-label" id="count-vehicles"></div>
<div class="tbl-wrap"><table class="tbl"><thead><tr><th>Name/Label</th><th>Make</th><th>Model</th><th>Year</th><th>VIN</th><th>License Plate</th><th>Mileage</th><th>Status</th><th>Notes</th><th></th></tr></thead><tbody id="tbody-vehicles"></tbody></table></div></div><div class="tab-content" id="tab-maintenance">
<div class="stats" id="stats-maintenance"></div>
<div class="toolbar">
<input class="search" id="search-maintenance" placeholder="Search..." oninput="renderRes('maintenance')"><select class="filter-sel" id="filter-maintenance-service_type" onchange="renderRes('maintenance')"><option value="">All Service Type</option><option value="Oil Change">Oil Change</option><option value="Tires">Tires</option><option value="Brakes">Brakes</option><option value="Inspection">Inspection</option><option value="Repair">Repair</option><option value="Other">Other</option></select></div>
<div class="count-label" id="count-maintenance"></div>
<div class="tbl-wrap"><table class="tbl"><thead><tr><th>Vehicle ID</th><th>Service Type</th><th>Date</th><th>Mileage</th><th>Cost ($)</th><th>Provider</th><th>Notes</th><th></th></tr></thead><tbody id="tbody-maintenance"></tbody></table></div></div></div><div class="modal-bg" id="mbg" onclick="if(event.target===this)closeModal()"><div class="modal" id="mdl"></div></div><script>var A="/api",data={},editId=null,activeRes="vehicles";var resCfg={"vehicles":{d:"Vehicles",f:[{n:"name",l:"Name/Label",t:"text",r:true,o:[]},{n:"make",l:"Make",t:"text",r:false,o:[]},{n:"model",l:"Model",t:"text",r:false,o:[]},{n:"year",l:"Year",t:"integer",r:false,o:[]},{n:"vin",l:"VIN",t:"text",r:false,o:[]},{n:"license_plate",l:"License Plate",t:"text",r:false,o:[]},{n:"mileage",l:"Mileage",t:"integer",r:false,o:[]},{n:"status",l:"Status",t:"select",r:false,o:["Active","In Service","Out of Service","Retired"]},{n:"notes",l:"Notes",t:"textarea",r:false,o:[]}]},"maintenance":{d:"Maintenance",f:[{n:"vehicle_id",l:"Vehicle ID",t:"text",r:true,o:[]},{n:"service_type",l:"Service Type",t:"select",r:false,o:["Oil Change","Tires","Brakes","Inspection","Repair","Other"]},{n:"date",l:"Date",t:"date",r:true,o:[]},{n:"mileage",l:"Mileage",t:"integer",r:false,o:[]},{n:"cost",l:"Cost ($)",t:"number",r:false,o:[]},{n:"provider",l:"Provider",t:"text",r:false,o:[]},{n:"notes",l:"Notes",t:"textarea",r:false,o:[]}]},};
...
['vehicles','maintenance'].forEach(function(r){renderRes(r)});
}
}else{
